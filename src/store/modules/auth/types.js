...
export const GET_TIMER_ID = `${MODULE_NAME}/getters/getTimerId`;
...
export const MUTATE_SET_TIMER_ID = `${MODULE_NAME}/mutations/mutateSetTimerId`;
...
export const SET_LOGOUT_TIMER = `${MODULE_NAME}/actions/setLogoutTimer`;